...
def tf_attention():
    ...
    attention_mechanism = tf.contrib.seq2seq.LuongAttention(1, attention_states)
    ...
    attention_inputs = tf.random_normal(shape=[])
    attentioned_result = attentioned_decoder_cell(attention_states, attention_initial_state)
    '''
