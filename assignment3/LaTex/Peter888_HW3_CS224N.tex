...
\indent \indent \indent $\to$ $W_{z} \le 0$ and $W_{h} > 0$ \\
...
\indent \indent \indent $\to$ $W_{z} + U_{z} > 0$ or $W_{z} + U_{z} \le 0$ \\
...
\indent \indent \indent $\to$ $U_{z} > 0$ or ($U_{z} \le 0$ and $b_{r} > 0$ and $U_{h} > 0$)\\
...
\indent \indent \indent $\to$ $W_{z} + U_{z} \le 0$ and $W_{h} + r^{(t)} \circ U_{h} = 0$ \\
